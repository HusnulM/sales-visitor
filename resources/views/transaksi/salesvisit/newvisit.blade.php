...
<div class="container-fluid">
    <form action="{{ url('transaksi/salesvisit/savenew') }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <button type="button" class="btn btn-default btn-sm btn-scan-toko" style="display:none;">
                    ...
                    <div class="card-body">        
                        <div class="row">
                            <div class="col-lg-3 col-md-12">
                                <div class="form-group">
                                    <label for="tgl">Tanggal & Jam Kunjungan</label>
                                    <input type="datetime" name="tglKunjungan" class="form-control" value="{{ getLocalDatabaseDateTime() }}" readonly>
                                </div>
                            </div>
                            <!-- <div class="col-lg-2 col-md-12">
                                <div class="form-group">
                                    <label for="jam">Jam</label>
                                    <input type="date" name="jamKunjungan" class="form-control" value="{{ getCurrentTime() }}" readonly>
                                </div>
                            </div> -->
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-12">
                                <div class="form-group">
                                    <label for="contactperson">Contact Person / Pemilik Toko</label>
