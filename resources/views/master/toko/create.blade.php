...
@section('title', 'Tambah Master Toko')
...
<div class="container-fluid">
    <form action="{{ url('/master/toko/save') }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Tambah Master Toko</h3>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="namaOutlet" id="namaOutlet" class="form-control" autocomplete="off" required>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 mb-0">
                                        <div class="form-group">
                                            ...
                                            <textarea name="address" cols="30" rows="5" class="form-control" style="height: 124px;"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-12">
                                        <div class="form-group">
                                            <label for="desa">Kel/Desa</label>
                                            <input type="text" name="kelurahan" id="kelurahan" class="form-control" autocomplete="off">
                                        </div>
                                    </div>  
                                    <div class="col-lg-6 col-md-12">
                                        <div class="form-group">
                                            <label for="kecamtan">Kecamatan</label>
                                            <input type="text" name="kecamatan" id="kecamatan" class="form-control" autocomplete="off">
                                        </div>
                                    </div>  
                                    <div class="col-lg-6 col-md-12">
                                        <div class="form-group">
                                            <label for="kotamadya">Kab / Kotamadya</label>
                                            <input type="text" name="kotamadya" id="kotamadya" class="form-control" autocomplete="off">
                                        </div>
                                    </div>  
                                    <div class="col-lg-6 col-md-12">
                                        <div class="form-group">
                                            <label for="kodepos">Kode Pos</label>
                                            <input type="text" name="kodepos" id="kodepos" class="form-control" autocomplete="off">
                                        </div>
                                    </div>  
                                </div>
                            </div>
